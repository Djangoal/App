...
##########################################################################################
    ...
    ##########################################################################################    
                # Catégories
        checkbox_wrapper = BoxLayout(size_hint=(1, None), height=0.08 * Window.height, padding=4)
        ...
        # ✅ Conteneur responsive avec GridLayout (3 colonnes fixes)
        checkbox_container = GridLayout(
            cols=3,
            spacing=20,
            padding=[20, 0, 20, 0],  # marges gauche/droite
            size_hint=(1, None),
            height=0.07 * Window.height
        )
        
        # Création des cases
        self.revenu_cbox = CercledCheckbox("Revenu")
        self.charges_fixe_cbox = CercledCheckbox("Charge")
        ...
        # Enfin, ajout dans le layout principal
