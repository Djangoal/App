...
class ConfigurationScreen(Screen):
    def __init__(self, **kwargs):
        ...
        titre = Label(text="Page de Configuration", font_size=40)
        ...
        bouton_restant_a_payer = Button(text="Afficher/Masquer restant a payer", size_hint=(1, None), height=100)
        bouton_restant_a_payer.bind(on_press=self.on_toggle_restant_a_payer)
        layout.add_widget(bouton_restant_a_payer)
        ...
        logger.info("Écran Configuration chargé")
    ...
    def on_toggle_restant_a_payer(self, instance):
        app = App.get_running_app()
        app.show_restant_a_payer = not app.show_restant_a_payer
    ...
    def reinitialiser_donnees(self, instance):
        ...
        self.manager.get_screen("principal").  label_revenus.text  = "Solde: 0.00 €"
        self.manager.get_screen("principal").  label_depenses.text  = "Solde: 0.00 €"
        self.manager.get_screen("principal").  label_charges.text  = "Solde: 0.00 €"
