...
class LoginScreen(Screen):
    def __init__(self, **kwargs):
        ...
        font_large = Window.height * 0.06
        font_medium = Window.height * 0.05
        font_small = Window.height * 0.04

        layout = BoxLayout(orientation='vertical', padding=padding_vertical, spacing=spacing)
